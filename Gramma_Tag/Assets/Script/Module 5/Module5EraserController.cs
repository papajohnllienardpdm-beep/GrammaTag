...
public class Module5EraserController : MonoBehaviour
{
    [Header("References")]
    public Canvas canvas;
    public RectTransform originalEraser;
    public RectTransform floatingEraser;
    public Module5BoardCleanerManager gameManager;
    ...
    bool IsPressedOnOriginalEraser()
    {
        ...
        return RectTransformUtility.RectangleContainsScreenPoint(originalEraser, screenPos, cam);
    }
    ...
    {
        if (gameManager != null)
            gameManager.CheckEraserCollision(floatingEraser.anchoredPosition, eraseRadius);
    }
